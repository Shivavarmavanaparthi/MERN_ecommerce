import{Mail,UserPlus,Loader,User,ArrowRight,Lock} from "lucide-react"
  ...
  return (
    <div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
        <motion.div
            ...
            >
                <h2 className='mt-6 text-center text-3xl font-emerald text-emerald-400'>Create your account</h2>
        </motion.div>
