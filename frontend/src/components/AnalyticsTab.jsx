  ...
  useEffect(() => {
    const fetchAnalyticsData = async () => {
      try {
        ...
        const rawDailyData = response.data.dailySalesData || {};

        // Transform object to array for Recharts
        const transformedData = Object.entries(rawDailyData).map(([date, data]) => ({
          name: date,
        ...
        console.log("Transformed dailySalesData:", transformedData); // debug
